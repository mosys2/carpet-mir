...
namespace Store.Persistence.Migrations
{
    ...
    [Migration("20230930141745_RemovePageCreatorForeignKeyFromGroupItem")]
    partial class RemovePageCreatorForeignKeyFromGroupItem
    {
            ...
            modelBuilder.Entity("Store.Domain.Entities.Groups.GroupItem", b =>
                {
                    ...
                    b.Property<string>("PageCreatorId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Store.Domain.Entities.Groups.GroupItem", b =>
                {
                    ...
                    b.HasOne("Store.Domain.Entities.Pages.PageCreator", "PageCreator")
                        .WithMany("GroupItems")
                        .HasForeignKey("PageCreatorId");

                    b.Navigation("Group");

                    b.Navigation("Language");

                    b.Navigation("PageCreator");
                });
